...
"[project]/src/checkoutActions/data:9d64ae [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
function CheckOut() {
    ...
    async function handleOnline(value) {
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$checkoutActions$2f$data$3a$9d64ae__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["default"])(id, "http://localhost:3000/", value);
            console.log(res);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5338a11._.js.map
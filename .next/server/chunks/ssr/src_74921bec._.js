...
function CheckOut({ id }) {
    ...
    const { data: session } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSession"])(); // 👈 جبت بيانات اليوزر
    async function handleOnline(value) {
        setLoading(true);
        try {
            // 👇 الـ success_url اللي هيرجع عليه بعد الدفع
            const successUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/allorders/${session?.user.id}`;
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$checkoutActions$2f$data$3a$9d64ae__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["default"])(id, successUrl, value);
...
//# sourceMappingURL=src_74921bec._.js.map
module.exports = [
"[project]/src/Api/getUserOrders.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Api$2f$getUserOrders$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/Api/getUserOrders.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Page() {
    ...
    async function fetchOrders() {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Api$2f$getUserOrders$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(session?.user.id);
        console.log(data);
        setorders(data);
        console.log(orders);
    }
...
//# sourceMappingURL=_0ba19c03._.js.map